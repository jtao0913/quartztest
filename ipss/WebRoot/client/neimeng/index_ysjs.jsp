...
<input type="hidden" id="navID" name="navID" value="153" />
<input type="hidden" id="hangye" name="hangye" value="ysjs" />

<div class="wrap">
<div class="home_box2" style="background:url(images/bj_ysjs.jpg) no-repeat center;">
<dl class="home_login" style="padding:240px 0 0 415px;">
<dd><strong>用户名：</strong><input class="text" name="username" id="username" type="text" value="ysjs" style="background:url(images/text_iput.gif) no-repeat center;width:150px;"/></dd>
