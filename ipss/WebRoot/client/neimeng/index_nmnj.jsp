...
<input type="hidden" id="navID" name="navID" value="1" />
<input type="hidden" id="hangye" name="hangye" value="nmnj" />

<div class="wrap">
<div class="home_box2" style="background:url(images/bj_nmnj.jpg) no-repeat center;">
<dl class="home_login" style="padding:240px 0 0 415px;">
<dd><strong>用户名：</strong><input class="text" name="username" id="username" type="text" value="nmnj" style="background:url(images/text_iput.gif) no-repeat center;;width:150px;"/></dd>
