...
<input type="hidden" id="navID" name="navID" value="384" />
<input type="hidden" id="hangye" name="hangye" value="xcy" />

<div class="wrap">
<div class="home_box2" style="background:url(images/bj_xcy.jpg) no-repeat center;">
<dl class="home_login" style="padding:270px 0 0 415px;">
<dd><strong>用户名：</strong><input class="text" name="username" id="username" type="text" value="xcy" style="background:url(images/text_iput.gif) no-repeat center;;width:150px;"/></dd>
