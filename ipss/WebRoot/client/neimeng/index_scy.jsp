...
<title>中国内蒙古自治区沙产业专利</title>
<link href="css/css_nmnj.css" rel="stylesheet" type="text/css" />
</head>

<body style="background:url(image/bg.jpg);background-position:center;background-position: top;background-repeat: no-repeat;margin:0;padding:0;">
<form method="post" name="loginform" action="login.do?method=login"  > 
<input type="hidden" id="navID" name="navID" value="281" />
<input type="hidden" id="hangye" name="hangye" value="scy" />
<div class="wrap">
<div class="home_box2" style="background:url(images/bj_scy.jpg) no-repeat center;">
<dl class="home_login">
<dd><strong>用户名：</strong><input class="text" name="username" id="username" type="text" value="scy" style="background:url(images/text_iput.gif) no-repeat center;width:150px;"/></dd>
...
<dt><a href="#" onclick="initLoginRequestData()" class="dl" style="background:url(images/but.jpg) no-repeat center;">登 录</a></dt>
</dl>
</div>
