...
<input type="hidden" id="navID" name="navID" value="69" />
<input type="hidden" id="hangye" name="hangye" value="nmnx" />

<div class="wrap">
<div class="home_box2" style="background:url(images/bj_nmnx.jpg) no-repeat center;height:655px;">
<dl class="home_login">
<dd><strong>用户名：</strong><input class="text" name="username" id="username" type="text" value="nmnx" style="background:url(images/text_iput.gif) no-repeat center;;width:150px;"/></dd>
...
<div class="login_foot">主办单位　　内蒙古自治区知识产权局　　呼伦贝尔市知识产权局　　扎兰屯市知识产权局</div>
</div>
</form>
