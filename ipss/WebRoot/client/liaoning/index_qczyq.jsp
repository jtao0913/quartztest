...
<div class="ha_all" style="background-image: url(liaoning/images/qczyq.jpg)">
<form method="post" name="loginform" action="login.do?method=login">
<input type="hidden" id="navID" name="navID" value="7201" />
<input type="hidden" id="hangye" name="hangye" value="qczyq" />
...
<input type="hidden" name="url" value="zljs/index.jsp"> 
	  <div class="login">
		<ul>用户名： <input name="username" id="username" type="text" class="border" value="qczyq"/></ul>
