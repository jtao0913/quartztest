...
<head>
	...
	<link href="client/liaoning/css/liaoning.css" rel="stylesheet" type="text/css"/>
</head>

<body style="background-image:url(client/liaoning/images/bg_a.jpg); background-repeat:repeat-x; background-color:#F1F1F1;">
<div class="ha_all" style="background-image: url(client/liaoning/images/gdz.jpg)">
<form method="post" name="loginform" action="login.do?method=login">
<input type="hidden" id="navID" name="navID" value="986" />
<input type="hidden" id="hangye" name="hangye" value="qicheban" />
...
<input type="hidden" name="url" value="zljs/index.jsp"> 
	  <div class="login">
		<ul>用户名： <input name="username" id="username" type="text" class="border" value="gdz"/></ul>
		<ul class="m_t1">密　 码：<input name="password" type="password"  class="border" id="password" value="123456"/>	</ul>
		<ul class="m_t1 p_l1"> 
		  	<a href="#" target="_self">
		  		<img onClick="javascript:initLoginRequestData();" src="client/liaoning/images/dl.jpg" border="0" />
		  	</a><br>
		</ul>
