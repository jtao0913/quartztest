...
[首&nbsp;页]
<%}else{%>
<a href="1_user_submit.jsp?year1=<%=year_from%>&month1=<%=month_from%>&day1=<%=day_from%>&year2=<%=year_to%>&month2=<%=month_to%>&day2=<%=day_to%>&userName=<%=userName%>&selectScope=<%=selectScope%>&paixu=<%=paixu%>&pageNumber=1">[首&nbsp;页]</a>
<%}%>
</td>
<td>
<%if(pageCount==1 || pageNumber==1){%>
[上一页]
<%}else{%>
<a href="1_user_submit.jsp?year1=<%=year_from%>&month1=<%=month_from%>&day1=<%=day_from%>&year2=<%=year_to%>&month2=<%=month_to%>&day2=<%=day_to%>&userName=<%=userName%>&selectScope=<%=selectScope%>&paixu=<%=paixu%>&pageNumber=<%=(pageNumber-1)%>">[上一页]</a>
<%}%>
</td>
<td>
...
[下一页]
<%}else{%>
<a href="1_user_submit.jsp?year1=<%=year_from%>&month1=<%=month_from%>&day1=<%=day_from%>&year2=<%=year_to%>&month2=<%=month_to%>&day2=<%=day_to%>&userName=<%=userName%>&selectScope=<%=selectScope%>&paixu=<%=paixu%>&pageNumber=<%=(pageNumber+1)%>">[下一页]</a>
<%}%>
</td>
<td>
<%if(pageCount==pageNumber || pageCount==1){%>
[尾&nbsp;页]
<%}else{%>
<a href="1_user_submit.jsp?year1=<%=year_from%>&month1=<%=month_from%>&day1=<%=day_from%>&year2=<%=year_to%>&month2=<%=month_to%>&day2=<%=day_to%>&userName=<%=userName%>&selectScope=<%=selectScope%>&paixu=<%=paixu%>&pageNumber=<%=pageCount%>">[尾&nbsp;页]</a>
<%}%>
</td>
</tr>
</table>
