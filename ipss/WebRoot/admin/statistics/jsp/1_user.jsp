    ...
    <td align="center" valign="top">
    	<table width="100%" bordercolordark="#ffffff" bordercolorlight="#4787b8" border="0" cellpadding="0" cellspacing="0">
        	<tr align="center"> 
			  ...
			  <form name="stats" action="1_user_submit.jsp" method="post">
			  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolorlight="#4787b8" bordercolordark="#FFFFFF">
                ...
                <tr>
				  ...
				  <select name="selectScope" style="width:133">
				...
				<%}else{%>
				<input type="hidden" name="selectScope" value="<%=adminID%>">				
				<%}%>
				<tr>
				<td><div align="center">排序：</div></td>
				<td>
				<select name="paixu" style="width:133">
				<option value="0" selected>不排序</option>
				<option value="1">中国专利原文打印</option>
				<option value="2">中国专利原文下载</option>
				<option value="3">国外专利文摘打印</option>
				<option value="4">国外专利文摘下载</option>
				</select>
				</td>
				</tr>
                <tr>
                  <td><div align="center">请输入要统计用户名：</div></td>
                  <td height="24" colspan="2"><input name="strUserName" type="text" size="15">
                  （留空表示全部）</td>
                </tr>
                <tr>
