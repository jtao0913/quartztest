...
<% 
	...
	GroupManage groupmanage=new GroupManage(number,indexPage,strWord);
	String groupNames[]=new String[number];
	String groupMemos[]=new String[number];
	int groupIDs[]=new int[number];
	
	groupNames=groupmanage.getGroupNames();
	groupMemos=groupmanage.getGroupMemos();
	groupIDs=groupmanage.getGroupIDs();
	num=groupmanage.getCount();
...
<!--
	function checkpageform(form)
	{
		...
		if(form.biaozhi.value<=0 || form.biaozhi.value>10)
		{
...
<table width="100%" height="38" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"><img src="../../images/yhqxzgl.gif" width="288" height="22"> </td>
  </tr>
</table>
              ...
              <tr> 
                ...
                <td width="93%"> 
                  <table width="350" height="23" border="0" cellpadding="0" cellspacing="0" class="12green">
                    <form name="form1" method="post" action="grouplist.jsp">
					<tr> 
                        <td>用户组名称：<input type="text" name="searchWord" size="15" value="<%=strWord%>"></td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"> <table cellspacing=0 bordercolordark=#ffffff width="100%" bordercolorlight=#4787b8 border=1>
        <tbody>
        <form name="form2" method="post" action="deletegroup.jsp">
          <tr bgcolor="#4787b8"> 
            <td width="6%" nowrap>&nbsp;</td>
            <td width="7%" align="center" nowrap><font color="#ffffff"><b>序 号</b></font></td>
            <td width="20%" align="center" nowrap><font color="#ffffff"><b>用户组名</b></font></td>
            <td width="25%" align="center" nowrap><font color="#ffffff"><b>用户组说明</b></font></td>
            <td width="7%" align="center" nowrap><font color="#ffffff"><b>修改</b></font></td>
            <td width="7%" align="center" nowrap><font color="#ffffff"><b>成员维护</b></font></td>
            <td width="7%" align="center" nowrap><font color="#ffffff"><b>复制为...</b></font></td>
          </tr>
          <%
			...
			%>
          <tr> 
            <td width="6%" align="center"> <input type="checkbox" name="sel" value="<%=groupIDs[i-1]%>"> 
            </td>
            <%
						out.print("<td width='7%' align='center' >"+i+"</td>");
						out.print("<td width='20%' align='left' >"+groupNames[i-1]+"&nbsp;</td>");
						out.print("<td width='30%' align='left' >"+groupMemos[i-1]+"&nbsp;</td>");
				%>
            <td width="7%" align="center"><a href="updategroup.jsp?groupid=<%=groupIDs[i-1]%>" onClick="javaScript:event.returnValue=false;window.open('updategroup.jsp?groupid=<%=groupIDs[i-1]%>','','width=800,height=600,scrollbars=yes');"><img src="../../../images/icon_edit.gif" border="0"></a></td>
            <td width="7%" align="center"><a href="groupuser.jsp?groupid=<%=groupIDs[i-1]%>" onClick="javaScript:event.returnValue=false;window.open('groupuser.jsp?groupid=<%=groupIDs[i-1]%>','','width=800,height=600,scrollbars=yes');"><img src="../../../images/icon_edit.gif" border="0"></a></td>
            <td width="7%" align="center"><a href="groupclone.jsp?groupid=<%=groupIDs[i-1]%>" onClick="javaScript:event.returnValue=false;window.open('groupclone.jsp?groupid=<%=groupIDs[i-1]%>','','width=400,height=600,scrollbars=yes');"><img src="../../../images/icon_edit.gif" border="0"></a></td>
          </tr>
          <%
		       }
		   %>
