        ...
        <tr>
          ...
          <td width="98%">
            <table width="100%" border="1" height="100%" cellspacing="0" cellpadding="0" bordercolordark="#ffffff" bordercolorlight="a8c5e2">
              <form name="form1" method="post" action="addadminsubmit.jsp">
                <tr> 
                  <td align="right" width="35%" height="25">管理员名称：</td>
                  <td> 
                    <input type="text" name="adminname" maxlength="128"size="15">
				...
				<tr>
                  ...
                  <td><input type="text" name="adminIP" maxlength="128"size="15">
                  (<font color="red">*</font>) </td>
                </tr>
				<tr>
	        ...
	        <select name="adminRight" size="8" multiple style="width=150">
			<%
			for(int i=0;i<rightIDs.length;i++)
			{
			  ...
			  {
			%>
			<option value="<%=rightIDs[i]%>" selected><%=rightNames[i]%></option>
			<%			  
			  }
			  else
			  {
%>
            <option value="<%=rightIDs[i]%>"><%=rightNames[i]%></option>
<%                 
			  }
			}
			%>
