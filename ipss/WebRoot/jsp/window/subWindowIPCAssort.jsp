...
function zTreeOnClick111(event, treeId, treeNode) {
    var flhs = $('#flhs').val();
...
<body style="padding:20px;">
			...
			<div class="muted" style="font-size:12px;">
				 <font style="color:#cc6600;">提示:</font> 请使用“IPC分类表查询”或浏览“IPC分类”树的方式，选择您所要作为检索条件的IPC分类号，选中的IPC分类号将会自动填写到“专利检索”的“分类号”中，作为检索条件，进行专利信息查询。
				可以多次选择不同的IPC分类号，所选的IPC分类号将以“或”的关系成为检索条件。</div>
			<div class="windows_title"><strong style="color:#3399cc;">分类号：</strong></div>
