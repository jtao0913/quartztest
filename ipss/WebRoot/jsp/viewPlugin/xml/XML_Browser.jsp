...
<frameset name="fsMain" rows="30,*" cols="*" framespacing="0" frameborder="no" border="0">
  	...
  	<frame src="<%=basePath%>renderXML.do?method=renderXML&an=${requestScope.an}&channelIDs=${requestScope.channel}&pd=${requestScope.pd}&ft_type=<%=ft_type%>&pageIndex=${requestScope.pageIndex}&CLM_Page=${requestScope.CLM_Page}&DES_Page=${requestScope.DES_Page}&DRA_Page=${requestScope.DRA_Page}" name="rightFrame" id="right" >
  	</frameset>
</frameset>
<noframes>
	<body>
