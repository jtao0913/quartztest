...
function OnSetDownloadOption()
{
	...
	alert(strSelect==3);
	alert(strSelect=="3");
	alert(txtBeginPageNumber==1);
	alert(txtBeginPageNumber=="1");
	alert(txtEndPageNumber==m_strPage);
	*/
	//alert(txtEndPageNumber);
	//alert(m_strPage);
...
function OnPageLoad()
{
	...
	if(DRA_Page==0 || DRA_Page=="0"){
		document.all.xmlType[2].disabled=true;
	}else{
...
<center><font size="3"><B><span id="f1"></span>下载设置</B></font></center><br>

  <table width="335" border="0" align="center">
    <tr><td>
	<input type="radio" name="xmlType" value="1" checked id="x1" onClick="switchFT_Type(1)"><label for="x1">&nbsp;下载权利要求书</label>
	<input type="radio" name="xmlType" value="2" id="x2" onClick="switchFT_Type(2)"><label for="x2">&nbsp;下载说明书</label>
	<input type="radio" name="xmlType" value="3" id="x3" onClick="switchFT_Type(3)"><label for="x3">&nbsp;下载说明书附图</label>
	</td></tr>
	<tr>
      <td>
      <fieldset>
  ...
  <table width="335" border="0" align="center">
    <tr>
      <td colspan="2" style="cursor:hand"><input type="radio" name="rdSelect" value="1" checked id="c1"><label for="c1">&nbsp;下载整件<span id="f2"></span></label></td>
    </tr>
    <!--<tr>
      <td colspan="2" style="cursor:hand"><input type="radio" name="rdSelect" value="2" id="c2"><label for="c2">&nbsp;下载当前页</label></td>
    </tr>-->
    <tr>
      <td style="cursor:hand"><input type="radio" name="rdSelect" value="3" id="c3"><label for="c3">&nbsp;下载指定页</label></td>
