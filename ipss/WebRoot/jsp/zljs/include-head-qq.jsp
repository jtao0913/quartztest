...
<SCRIPT type="text/javascript" src="<%=basePath%>js/contact/kefu.js"></SCRIPT>

<%
String QQ400 = com.cnipr.cniprgz.commons.DataAccess.getProperty("QQ400");
//System.out.println("111QQ400="+QQ400);
QQ400 = (QQ400==null||QQ400.equals(""))?"1":QQ400;
//System.out.println("222QQ400="+QQ400);
%>
...
<div class="right_contact_img" style="z-index: 9998; right: 0px;">
  <ul>
    <li>
    	<a href="javascript:getQQ();">
        	<img src="<%=basePath%>images/contact/kf_qqsmall.png" width="56" height="56">
        </a>
      	<div class="pull_down2 qq" style="right: -201px;">
        	<a href="javascript:getQQ();">
            	<img src="<%=basePath%>images/contact/kf_img2.png" width="180" height="56">
            </a>
        </div>
    </li>
    <li>
        <a href="javascript:;">
        <img src="<%=basePath%>images/contact/kf_phone.png" width="56" height="56">
        </a>
        <div class="pull_down2 dianhua" style="right: -201px;">
            <a href="javascript:;">
               <img src="<%=basePath%>images/contact/kf_img3.png" width="180" height="56">
            </a>
        </div>
    </li>    
  </ul>
...
.right_contact_img ul{list-style:none; margin:0; padding:0}
...
.right_contact_img ul li .pull_down2 a:hover{
	opacity:1;	
}
</style>
...
function getQQ(){
	$('#wapqq').find('iframe').contents().find('#launchBtn').click();
}

$(function(){
   $(".right_contact_img ul li").hover(function(){
...
<div id="wapqq" style="display:none;">
<!-- 
<SCRIPT src="<%=basePath%>js/contact/wpa.js"></SCRIPT>
-->
<script type="text/javascript">
...
BizQQWPA.setVersion("3.3.7.20160126").load({"wty":"1","a":"1001","nameAccount":"4001880860","type":"1","sv":"4","title":"","aty":"0","a":"0","ws":"www.cnipr.com","btn1":"\u8425\u9500QQ\u4ea4\u8c08","btn2":"","fsty":"0","fposX":"0","fposY":"0","csty":"1","tx":"1","txw":null,"txh":null,"wd":"","wd2":"","curl":"","wid":"","di":""},{"wty":"1","a":"1002","nameAccount":"4001880860","type":"1","sv":"4","title":"","aty":"0","a":"0","ws":"www.cnipr.com","btn1":"\u8425\u9500QQ\u4ea4\u8c08","btn2":"","fsty":"0","fposX":"0","fposY":"0","csty":"1","tx":"1","txw":null,"txh":null,"wd":"","wd2":"","curl":"","wid":"","di":""});
</script>
</div>
<%}%>
