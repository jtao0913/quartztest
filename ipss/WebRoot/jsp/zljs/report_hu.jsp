...
<script type="text/javascript" src="../../analyse/echarts.js"></script>
<script type="text/javascript" src="../../analyse/echarts.min1.js"></script>
<script type="text/javascript" src="../../analyse/china.js"></script>
<script type="text/javascript">
window.onload=function() {
	//全球专利总量分析
	$.ajax({
		type : "GET",
		url :  "/ipss/patentAnalysisXYcopy.do",
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_1,2016,2018",
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
