...
window.onload=function() {
	...
	$.ajax({
		type : "POST",
		url :  "<%=basePath%>/patentAnalysisXYcopy.do",
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_1,2014,2018",
			'nodeId' : 0,
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
		...
		"success" : function(result) {//响应成功时候的回调函数
			...
			myChart.setOption({
			    ...
			    dataset: {
			        source: [
			            ['product', '世界', '中国', '广东省'],
			            ['2018', one['2018']['全球'], one['2018']['中国'], one['2018']['广东省']],
			            ['2017', one['2017']['全球'], one['2017']['中国'], one['2017']['广东省']],
			            ['2016', one['2016']['全球'], one['2016']['中国'], one['2017']['广东省']],
			        ]
			    },
			    xAxis: {type: 'category'},
			    yAxis: {},
			...
			//表格填充
			$("#Excle0").html(one['2018']['全球']);$("#Excle1").html(one['2017']['全球']);$("#Excle2").html(one['2016']['全球']);
			$("#Excle3").html(one['2018']['中国']);$("#Excle4").html(one['2017']['中国']);$("#Excle5").html(one['2016']['中国']);
			$("#Excle6").html(one['2018']['广东省']);$("#Excle7").html(one['2017']['广东省']);$("#Excle8").html(one['2016']['广东省']);
			//获取表格信息并存到隐藏域中
			for(var i=0;i<9;i++){
...
function func_1_2_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_2_1,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
		...
		"success" : function(result) {// 响应成功时候的回调函数
			...
			//$("#Excle9").html(Exl1[0]);$("#Excle10").html(Exl1[1]);$("#Excle11").html(Exl1[2]);
			var num=12;
...
function func_1_2_2() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_2_2,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
		...
		"success" : function(result) {// 响应成功时候的回调函数
			...
			//将表格数据存入隐藏域
			for(var i=36;i<63;i++){
				var tem=$("#Excle"+i).html().replace(/\</g,"{");
				tem=tem.replace(/\>/g,"}");
				$("#ecl"+i).val(tem);
			}
			func_1_2_3();
...
function func_1_2_3() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_2_3,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_1_3_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_3_1,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_1_3_2() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_3_2,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_1_3_3() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_3_3,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_1_4_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_1_4_1,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_1,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_2() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_2,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
		...
		"success" : function(result) {//响应成功时候的回调函数
			...
			//表格填充
			$("#Excle120").html(one['2018']['发明']);$("#Excle121").html(one['2017']['发明']);$("#Excle122").html(one['2016']['发明']);
			$("#Excle123").html(one['2018']['新型']);$("#Excle124").html(one['2017']['新型']);$("#Excle125").html(one['2016']['新型']);
			$("#Excle126").html(one['2018']['外观']);$("#Excle127").html(one['2017']['外观']);$("#Excle128").html(one['2016']['外观']);
			//获取表格信息并存到隐藏域中
...
function func_2_3_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_3_1,2014,2018",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_4_1() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_4_1,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_4_2() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_4_2,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_4_3() {
	$.ajax({
		...
		data : {
			'dbs' : "fmzl_ft,syxx_ft,wgzl_ab,fmsq_ft",
			'hangye' : "gd_zbzz_2_4_3,2014,2018,1-1",//错误
			'xAxis' : "",
			'yAxis' : "",
			'xAxisSize' : "",
			'yAxisSize' : "",
...
function func_2_7_1() {
	$.ajax({
		...
		"success" : function(result) {// 响应成功时候的回调函数
			...
			$("#Excle160").html(one['2018']['失效']);$("#Excle161").html(one['2017']['失效']);$("#Excle162").html(one['2016']['失效']);
...
function func_2_7_2() {
	$.ajax({
		...
		"success" : function(result) {// 响应成功时候的回调函数
			var Exl1=JSON.parse(result);
			var a=Exl1['有效'];var b=Exl1['失效'];var c=Exl1['在审'];var d=Exl1['不确定'];
...
function func19() {
	$.ajax({
		...
		"success" : function(result) {//响应成功时候的回调函数
			...
			//表格填充
			$("#Excle181").html(one['2018']['发明']);$("#Excle182").html(one['2017']['发明']);$("#Excle183").html(one['2016']['发明']);
			$("#Excle184").html(one['2018']['新型']);$("#Excle185").html(one['2017']['新型']);$("#Excle186").html(one['2016']['新型']);
			$("#Excle187").html(one['2018']['外观']);$("#Excle188").html(one['2017']['外观']);$("#Excle189").html(one['2016']['外观']);
			//获取表格信息并存到隐藏域中
...
function func_3_7_1() {
	$.ajax({
		...
		"success" : function(result) {// 响应成功时候的回调函数
			...
			$("#Excle221").html(one['2018']['失效']);$("#Excle222").html(one['2017']['失效']);$("#Excle223").html(one['2016']['失效']);
...
<body>
	...
	<table style="width: 800px;">
		...
		<tr>
			<td>1</td><td>世界</td><td id="Excle0">加载中</td><td id="Excle1">加载中</td><td id="Excle2">加载中</td>
		</tr>
		<tr>
			<td>2</td><td>中国</td><td id="Excle3">加载中</td><td id="Excle4">加载中</td><td id="Excle5">加载中</td>
		</tr>
		<tr>
			<td>3</td><td>广东</td><td id="Excle6">加载中</td><td id="Excle7">加载中</td><td id="Excle8">加载中</td>
		</tr>
	</table>
	<h2>1.2 区域分析</h2>
	<h2>1.2.1 区域构成分析</h2>
	...
	<div id="temp2" style="display: none;">
		<table style="width: 800px;">
			<tr>
				<th>排名</th><th>区域</th><th id="Excle9">2018年</th><th id="Excle10">2017年</th><th id="Excle11">2016年</th>
			</tr>
			<tr>
				<td>1</td><td id="Excle12">加载中</td><td id="Excle13">加载中</td><td id="Excle14">加载中</td><td id="Excle15">加载中</td>
			</tr>
			<tr>
				<td>2</td><td id="Excle16">加载中</td><td id="Excle17">加载中</td><td id="Excle18">加载中</td><td id="Excle19">加载中</td>
			</tr>
			<tr>
				<td>3</td><td id="Excle20">加载中</td><td id="Excle21">加载中</td><td id="Excle22">加载中</td><td id="Excle23">加载中</td>
			</tr>
			<tr>
				<td>4</td><td id="Excle24">加载中</td><td id="Excle25">加载中</td><td id="Excle26">加载中</td><td id="Excle27">加载中</td>
			</tr>
			<tr>
				<td>5</td><td id="Excle28">加载中</td><td id="Excle29">加载中</td><td id="Excle30">加载中</td><td id="Excle31">加载中</td>
			</tr>
			<tr>
				<td>6</td><td id="Excle32">加载中</td><td id="Excle33">加载中</td><td id="Excle34">加载中</td><td id="Excle35">加载中</td>
			</tr>
		</table>
		</div>
	<h2>1.2.2 区域技术分析</h2>
	...
	<div id="temp4" style="display: none;">
		<table style="width: 800px;">
			<tr>
				<th>排名</th><th>区域</th><th id="Excle36">2018年</th><th id="Excle37">2017年</th><th id="Excle38">2016年</th>
			</tr>
			<tr>
				<td>1</td><td id="Excle39">加载中</td><td id="Excle40">加载中</td><td id="Excle41">加载中</td><td id="Excle42">加载中</td>
			</tr>
			<tr>
				<td>2</td><td id="Excle43">加载中</td><td id="Excle44">加载中</td><td id="Excle45">加载中</td><td id="Excle46">加载中</td>
			</tr>
			<tr>
				<td>3</td><td id="Excle47">加载中</td><td id="Excle48">加载中</td><td id="Excle49">加载中</td><td id="Excle50">加载中</td>
			</tr>
			<tr>
				<td>4</td><td id="Excle51">加载中</td><td id="Excle52">加载中</td><td id="Excle53">加载中</td><td id="Excle54">加载中</td>
			</tr>
			<tr>
				<td>5</td><td id="Excle55">加载中</td><td id="Excle56">加载中</td><td id="Excle57">加载中</td><td id="Excle58">加载中</td>
			</tr>
			<tr>
				<td>6</td><td id="Excle59">加载中</td><td id="Excle60">加载中</td><td id="Excle61">加载中</td><td id="Excle62">加载中</td>
			</tr>
		</table>
		</div>
	<h2>1.2.3 区域申请人分析</h2>
	...
	<div id="temp6" style="display: none;">
		<table style="width: 800px;">
			<tr>
				<th>排名</th><th>区域</th><th id="Excle63">2018年</th><th id="Excle64">2017年</th><th id="Excle65">2016年</th>
			</tr>
			<tr>
	...
	<div id="temp16" style="display: none;">
		<table id="Excle116" style="width: 800px;">
			...
			<tr>
				<td>1</td><td>发明</td><td id="Excle120">加载中</td><td id="Excle121">加载中</td><td id="Excle122">加载中</td>
			</tr>
			<tr>
				<td>2</td><td>新型</td><td id="Excle123">加载中</td><td id="Excle124">加载中</td><td id="Excle125">加载中</td>
			</tr>
			<tr>
				<td>3</td><td>外观</td><td id="Excle126">加载中</td><td id="Excle127">加载中</td><td id="Excle128">加载中</td>
			</tr>
		</table>
		</div>
	<h2>2.3 国省分布状况分析</h2>
	...
	<div id="temp32" style="display: none;">
		<table id="Excle169" style="width: 800px;">
			<tr>
				<th>区域</th><th>有效</th><th>失效</th><th>在审</th><th>不确定</th>
			</tr>
		</table>
		</div>
	<h2>第三章 广东省专利监测分析</h2>
