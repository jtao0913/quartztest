...
//			alert(kkpager.total+"----"+kkpager.totalRecords);
//			alert(this._config.total+"----"+this._config.totalRecords);
			this._config['pno'] = n;
			this.inited = false;
...
//alert("generPageHtml......");
			/*
			alert(kkpager.total+"----"+kkpager.totalRecords);
//			alert(kkpager.totalRecords);
			
//			alert(config.totalRecords);	
			*/
//			alert(config.total+"----"+config.totalRecords);
//			alert("generPageHtml...");
