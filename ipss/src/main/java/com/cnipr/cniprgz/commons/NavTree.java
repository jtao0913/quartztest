...
public class NavTree {
	...
	int intID = 0; // �û�ID
	private String chrName = null; // �û���
	private String chrExpression = null; // �û�����
	private String chrFRExpression = null; // ��ʵ����
	private String chrMemo = null; // ��ʵ����
	...
	public void getAllNavIDs(String[] arrTradeList) throws WASException{
		try{
...
//			ex.printStackTrace();
	...
	private void getNavIDsByParentID(int parentID) throws WASException{
		String strNavIDs="";
...
//			ex.printStackTrace();
	...
	public static void main(String[] args) throws WASException{
	...
	public void updateUserNav(int intNavID,int intUserID,String chrUserIP) throws WASException{
		Connection conn = null;
		PreparedStatement PrePareStmtUpdate = null;
		String strSQL="";
		try {
...
//        	ex.printStackTrace();
	...
	private String strSelNav1="";//����Ա�����Ȩ�ޣ��û���Ȩ�޵�һ���˵�
	private String strNavNew="";//���û���Ȩ�޵Ĳ˵��У���Ҫ��ʾnew��
	
	private String strNavNewCN="";
	private String strNavNewFR="";
	
	public void getNavShow(int intUserID) throws WASException{
		Connection conn = null;
		PreparedStatement PrePareStmt = null;
		ResultSet rs = null;
...
//        	ex.printStackTrace();
	...
	public int getRootID(int intParentID) throws WASException{
		int intRootID=0;
		Connection conn = null;
		PreparedStatement PrePareStmt = null;
		ResultSet rs = null;
...
//        	ex.printStackTrace();
	...
	public boolean getGDNavShow(int intUserID,int parentID) throws WASException{
		boolean b_use=false;
		Connection conn = null;
		PreparedStatement PrePareStmt = null;
		ResultSet rs = null;
...
//        	ex.printStackTrace();
	...
	public String[] getIPCNodeInfo(String parentIPCCode) throws WASException{
...
//        	ex.printStackTrace();
	...
	public String[] getNodeInfo(String OnlyNation_NavID,int parentid,int ipc_nav) throws WASException{
//System.out.println("NavTree------>getNodeInfo....................................");
		...
		try {
			conn = DBPoolAccessor.getConnection();;
			String strSQL="select intID intMainID,chrClass,chrName,chrExpression,chrFRExpression,chrCNChannels,chrFRChannels,intCNNavCount,intFRNavCount,(select count(*) from ipr_navtable where intType="+ipc_nav+" and " +
					"intParentID=intMainID) countChildren from ipr_navtable where intType="+ipc_nav+" and intParentID="+parentid;
...
//        	ex.printStackTrace();
	...
	public String[] getNodeInfoRight(int parentid,int intUserID) throws WASException{
		String[] arrNodeItem=null;
		String strNodeInfo="";
		Connection conn = null;
		PreparedStatement PrePareStmt = null;
...
//System.out.println(strNodeInfo);
    ...
    public String getSubEmailNavIDsByUser(int UserID,String strIPAddr) throws WASException{
    	String strSQL="";
...
//        	ex.printStackTrace();
	...
	public NavTree(int intID) throws WASException{
		Connection conn = null;
		PreparedStatement PrePareStmt = null;
		ResultSet rs = null;
		try {
