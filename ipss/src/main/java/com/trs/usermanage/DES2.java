...
public class DES2 {
	...
	public String decrypStr(String byteToString){
	...
	public static void main(String args[]) throws Exception {
		//加密源数据
//		encryptorString = "this is a test";
//		encryptorString = "cnipr";
//		encryptorString = "system";
//		encryptorString="QU89m1Knv2307XzA5";
//		encryptorString = "cnipr6421trs";
		String encryptorString = "manager";
